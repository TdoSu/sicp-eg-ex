...
;;; 报错 Exception in map: (procedure (x) ((+ x 2)) (((...) #f #t (...) (...) (...) ...))) is not a procedure
;;; 因为我们对 lambda 表达式的值采用了自己的定义方式 make-procedure
;;; 这和系统的 lambda 表达式实现并不相同, 系统的 map 不认识这个表示, 不会把他作为基本过程
